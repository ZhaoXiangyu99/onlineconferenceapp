...
public class Peer implements SdpObserver, PeerConnection.Observer {
    ...
    public Peer(PeerConnectionFactory factory, List<PeerConnection.IceServer> list, String userId, IPeerEvent event) {
        ...
        Log.d("test", "create Peer:" + mUserId);
    ...
    public void setLocalDescription(SessionDescription sdp) {
        Log.d("test", "setLocalDescription");
        if (pc == null) return;
    ...
    public void setRemoteDescription(SessionDescription sdp) {
        if (pc == null) return;
        Log.d("test", "setRemoteDescription");
    ...
    public void addLocalStream(MediaStream stream) {
        if (pc == null) return;
        Log.d("test", "addLocalStream" + mUserId);
        pc.addStream(stream);
    }

    // 添加RemoteIceCandidate
    public synchronized void addRemoteIceCandidate(final IceCandidate candidate) {
        Log.d("test", "addRemoteIceCandidate");
        if (pc != null) {
            if (queuedRemoteCandidates != null) {
               Log.d("test", "addRemoteIceCandidate  2222");
               ...
               Log.d("test", "addRemoteIceCandidate1111");
